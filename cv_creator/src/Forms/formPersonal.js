    ...
    return (
      <div className='formContainer'>
        ...
        <form id="personalForm">
          ...
          <textarea value={this.props.state.personal.description} rows="5" id="descriptionInput" placeholder="Type a description of yourself, or a mission statement. (optional)" onChange={e=>{this.props.personalEventHandler("description",e)}}  ></textarea>
        </form>
      </div>
    );
  }
